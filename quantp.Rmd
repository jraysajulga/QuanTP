...
singlesample_regression = function(PE_TE_data,htmloutfile, append=TRUE)
{
  ...
  cat(
    ...
    gsub("width:500px;height:500px", "width:600px;height:600px", getPlotlyLines(paste(outdir,"/PE_TE_lm_1.png",sep="",collapse=""))$plotly_div),
    '</td><td align=center><img src="PE_TE_lm_2.png" width=600 height=600>',
    gsub("width:500px;height:500px", "width:600px;height:600px", getPlotlyLines(paste(outdir,"/PE_TE_lm_2.png",sep="",collapse=""))$plotly_div),
    '</td></tr>\n', file = htmloutfile, append = TRUE);
  ...
  cat(
    ...
    gsub("width:500px;height:500px", "width:600px;height:600px", getPlotlyLines(paste(outdir,"/PE_TE_lm_5.png",sep="",collapse=""))$plotly_div)
    , '</td></tr>\n',
    file = htmloutfile, append = TRUE);
  ...
  cat(
    ...
    gsub("width:500px;height:500px", "width:800px;height:800px", getPlotlyLines(outplot)$plotly_div),
  ...
  cat("<tr><td>Mean Cook\'s distance</td><td>",mean(cooksd, na.rm=T),"</td></tr>\n",
    ...
    cat("<tr><td align=center><!--<font color='#ff0000'><h3>Scatter plot between Proteome and Transcriptome Abundance</h3></font>\n-->",
        ...
        gsub('id="html', 'id="secondhtml"',
             gsub("width:500px;height:500px", "width:600px;height:600px", getPlotlyLines(paste(outdir,"/TE_PE_scatter.png",sep="",collapse=""))$plotly_div)),
        '</td>\n',
        file = htmloutfile, append = TRUE);
    ...
    gsub("width:500px;height:500px", "width:600px;height:600px", getPlotlyLines(outplot)$plotly_div),
    # hello
    '</td></tr>\n',
    file = htmloutfile, append = TRUE);
    #@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
...
singlesample_heatmap=function(PE_TE_data, htmloutfile, hm_nclust){
  ...
  cat('<tr><td align=center colspan="2"><img src="PE_TE_heatmap.png" width=800 height=800>',
      gsub("width:500px;height:500px", "width:800px;height:800px", getPlotlyLines(outplot)$plotly_div), '</td></tr>\n',
    file = htmloutfile, append = TRUE);
    ...
    if(length(condition_ind)!=1)
        ...
        cat('<br><table  border=1 cellspacing=0 cellpadding=5 style="table-layout:auto; "> <tr bgcolor="#7a0019"><th><font color=#ffcc33>Transcript Fold-Change</font></th><th><font color=#ffcc33>Protein Fold-Change</font></th></tr>\n', file = htmloutfile, append = TRUE);
            cat("<tr><td align=center>", 
                ...
                getPlotlyLines(outplot_TE)$plotly_div,
                '</td>\n', file = htmloutfile, append = TRUE);
            cat("<td align=center>",
                '<img src="PE_volcano.png" width=600 height=600>',
                getPlotlyLines(outplot_PE)$plotly_div,
                '</td></tr></table><br>\n',
                file = htmloutfile, append = TRUE);
...
#===============================================================================
getPlotlyLines = function(outplot){
...
if(mode=="logfold")
{
  ...
  lines <- getPlotlyLines(outplot);
  postscripts <- c(postscripts, lines$postscripts);
  cat("<tr><td align=center>", '<img src="TE_PE_scatter.png" width=800 height=800>', lines$plotly_div, '</td></tr>\n', file = htmloutfile, append = TRUE);
  ...
  postscripts <- c(postscripts, c(getPlotlyLines(paste(outdir,"/PE_TE_lm_1.png",sep="",collapse=""))$postscripts,
                                  getPlotlyLines(paste(outdir,"/PE_TE_lm_2.png",sep="",collapse=""))$postscripts,
                                  getPlotlyLines(paste(outdir,"/PE_TE_lm_5.png",sep="",collapse=""))$postscripts,
                                  getPlotlyLines(paste(outdir,"/PE_TE_lm_cooksd.png",sep="",collapse=""))$postscripts,
                                  getPlotlyLines(paste(outdir,"/AbundancePlot_scatter_without_outliers.png",sep="",collapse=""))$postscripts));
  ...
  postscripts <- c(postscripts, getPlotlyLines(paste(outdir,"/PE_TE_heatmap.png",sep="",collapse=""))$postscripts)
  
  
  # TE PE Clustering (kmeans)
  singlesample_kmeans(PE_TE_data, htmloutfile, nclust=as.numeric(numCluster))
  postscripts <- c(postscripts, getPlotlyLines(paste(outdir,"/PE_TE_kmeans.png",sep="",collapse=""))$postscripts)
  ...
  if(mode=="multiple")
  {
    ...
    postscripts <- c(postscripts, getPlotlyLines(paste(outdir,"/TE_volcano.png",sep="",collapse=""))$postscripts)
    postscripts <- c(postscripts, getPlotlyLines(paste(outdir,"/PE_volcano.png",sep="",collapse=""))$postscripts)
    ...
    "<tr><td align=center>", '<img src="PCA_TE_all_rep.png" width=500 height=500>', PCA_TE$plotly_div, '</td>\n',
    "<td align=center>", '<img src="PCA_PE_all_rep.png" width=500 height=500>', PCA_PE$plotly_div, '</td></tr></table>\n', 
      file = htmloutfile, append = TRUE);
    ...
    lines <- getPlotlyLines(outplot);
    postscripts <- c(postscripts, lines$postscripts);  
    cat("<tr><td align=center>", '<img src="TE_PE_scatter.png" width=800 height=800>', gsub('width:500px;height:500px', 'width:800px;height:800px' , lines$plotly_div),
        '</td>\n', file = htmloutfile, append = TRUE);
    PE_TE_data = data.frame(PE_df, TE_df);
    colnames(PE_TE_data) = c("PE_ID","PE_abundance","TE_ID","TE_abundance");
    ...
    postscripts <- c(postscripts, c(getPlotlyLines(paste(outdir,"/PE_TE_lm_1.png",sep="",collapse=""))$postscripts,
                                  ...
                                  gsub('data-for="html', 'data-for="secondhtml"', 
                                       getPlotlyLines(paste(outdir,"/TE_PE_scatter.png",sep="",collapse=""))$postscripts)));
