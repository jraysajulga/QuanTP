...
singlesample_heatmap=function(PE_TE_data, htmloutfile, hm_nclust){
  ...
  cat('<tr><td align=center colspan="2">',
      ...
      gsub("width:960px;height:500px", "width:800px;height:800px", getPlotlyLines(outplot)$plotly_div),
      '</td></tr>\n',
    file = htmloutfile, append = TRUE);
...
if(mode=="logfold")
{
  ...
  lines <- getPlotlyLines(paste(outdir,"/PE_TE_heatmap.png",sep="",collapse=""))
  postscripts <- c(postscripts, lines$postscripts)
