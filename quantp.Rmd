...
jshtmloutfile = "test-files/test-jsoutput.html"


#
# Set up Plotly API authentication
#
Sys.setenv("plotly_username"="galaxyp")
Sys.setenv("plotly_api_key"="L1gyrR7gtvy0vw4jlydq")
...
#===============================================================================
# Insert JS lines into output HRML
#===============================================================================
...
getPlotlyLines = function(name){
  ...
  return(list(
  'prescripts'  = gsub('script', 'script', lines[grep(lines, pattern='<script src')]),
  'plotly_div'  = gsub('width:100%;height:400px','width:500px;height:500px', lines[grep(lines, pattern='plotly html-widget')]),
  'postscripts' = gsub('script', 'script', lines[grep(lines, pattern='<script type')])))
}
```
