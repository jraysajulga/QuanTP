...
1. Download and install Docker (<a href="https://www.docker.com/get-started" target="_blank">https://www.docker.com/get-started</a>). Once installed, open it and allow it to initialize.  
...
2. Install the container
   ...
   - The QuanTP image will be downloaded from the Docker Hub and will initialize  
...
3. Access your initialized QuanTP Docker container at <a href="http://localhost:8080" target="_blank">http://localhost:8080</a>.  
   - Optional: Register an account by following step 2 in the first section ( **Instructions**
   ...
   - To run through mouse data, go through the second section (**Supplementary for**  
...
4. Once finished with the Docker container, simply exit out of the Docker program to  
   ...
   - If you would like to keep Docker program running on your machine, you can terminate your container as follows:  
      - If you don't know your container ID, list out the container IDs with this
                command: ```docker ps```  
      - Using this ID, issue this command: ```docker kill [ID]```
